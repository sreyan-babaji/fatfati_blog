            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="post-header-image">
                    <img src="{{ asset('Assets/img/one.jpg') }}" class="card-img-top img-fluid rounded-top" 
                         alt="{{ $post_data->post_title }}" style="max-height: 400px; object-fit: cover;">
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="mb-4">
                        <h1 class="card-title display-5 fw-bold mb-3">{{ $post_data->post_title }}</h1>
                        ...
                        <div class="d-flex flex-wrap align-items-center text-muted mb-3">
                            ...
                            <div class="d-flex align-items-center me-4">
                                ...
                                <span>{{ $post_data->created_at->format('F j, Y') }}</span>
                            </div>
                    ...
                    <div class="post-content mb-5">
                        {!! nl2br(e($post_data->post_content)) !!}
                    </div>
